...
document.addEventListener("DOMContentLoaded", function () {
	...
	document.getElementById('search-input').addEventListener('input', function (e) {
		...
		var filteredData = fullTransactionData.filter(function (transaction) {
			var foundInName = transaction.name.toLowerCase().indexOf(searchString.toLowerCase()) > -1;
			...
			var foundInAmount = transaction.amount.toLowerCase().indexOf(searchString.toLowerCase()) > -1;
